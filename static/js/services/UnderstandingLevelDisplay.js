...
if (typeof module !== 'undefined' && module.exports) {
  ...
  // Explicitly expose instance methods as direct properties
  const methodsToCopy = ['initialize', 'fetchUnderstandingLevel', 'extractLevelFromDOM',
                          'updateDisplay', 'handleQuestionAnswered',
                          'startAutoRefresh', 'stopAutoRefresh'];

  methodsToCopy.forEach(method => {
    if (typeof understandingLevelDisplay[method] === 'function') {
      window.UnderstandingLevelDisplay[method] = understandingLevelDisplay[method].bind(understandingLevelDisplay);
    }
  });
}
