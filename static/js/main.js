...
function initializeGoalAdjustmentHandlers() {
    ...
    if (typeof GoalAdjustmentHandler === 'undefined') {
        console.log('GoalAdjustmentHandler not found. Attempting to load dynamically...');

        // Dynamically load the GoalAdjustmentHandler script
        const script = document.createElement('script');
        script.src = '/static/js/goal_adjustment_handler.js';
        script.async = false; // Load synchronously to ensure it's available before continuing

        // Set up onload handler
        script.onload = function() {
            console.log('GoalAdjustmentHandler loaded dynamically');
            ...
            if (typeof GoalAdjustmentHandler !== 'undefined') {
                ...
                console.log('GoalAdjustmentHandler initialized successfully');
            }
        };
...
function initializeScenarioComparisonHandlers() {
    ...
    if (typeof ScenarioComparisonHandler === 'undefined') {
        console.log('ScenarioComparisonHandler not found. Attempting to load dynamically...');

        // Dynamically load the ScenarioComparisonHandler script
        const script = document.createElement('script');
        script.src = '/static/js/scenario_comparison_handler.js';
        script.async = false; // Load synchronously to ensure it's available

        // Set up onload handler
        script.onload = function() {
            console.log('ScenarioComparisonHandler loaded dynamically');
            ...
            if (typeof ScenarioComparisonHandler !== 'undefined') {
                ...
                console.log('ScenarioComparisonHandler initialized successfully');
            }
        };
